...
function Badge({ className, variant = "default", ...props }: BadgeProps) {
  return (
    <span 
      className={cn(
        // Base styles - absolutely consistent
        "inline-flex items-center justify-center rounded-full border text-xs font-medium px-2 py-1 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 whitespace-nowrap shrink-0",
        // Variant styles  
